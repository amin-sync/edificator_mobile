...
class TeacherChattingPage extends StatefulWidget {
  final String receiverUserId;
  final String currentUserId;
  final String receiverName;
  final String receiverProfileUrl;
  const TeacherChattingPage({super.key, required this.receiverName, required this.receiverProfileUrl, required this.receiverUserId, required this.currentUserId});

  @override
  State<TeacherChattingPage> createState() => _TeacherChattingPageState();
}

class _TeacherChattingPageState extends State<TeacherChattingPage> {
